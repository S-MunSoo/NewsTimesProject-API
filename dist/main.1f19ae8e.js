      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            console.log(news);
            render();
            pageNation(); // render ui에 뿌려진 뉴스를 호이스팅을 이용해 호출한다.
          ...
          case 23:
            ...
            errorRender(_context.t0.message);
...
var pageNation = function pageNation() {
  // 페이지 숫자(li)태그들을 담아줄 변수 선언
  var pageNationHTML = ""; // pageGroup pageGroup 은 배열이다.

  var pageGroup = Math.ceil(page / 5); // last page

  var last = pageGroup * 5; // first page

  var first = last - 4; // 페이지 이동 첫번째 화살표 표시 onclick="moveToPage(${i-1})"

  if (first >= 6) {
    pageNationHTML = "  <li class=\"page-item\">\n  <a class=\"page-link\" href=\"#\" aria-label=\"Previous\" onclick=\"moveToPage(".concat(first - 1, ")\">\n    <span aria-hidden=\"true\">&lt;&lt</span>\n  </a>\n</li> <li class=\"page-item\">\n  <a class=\"page-link\" href=\"#\" aria-label=\"Previous\" onclick=\"moveToPage(").concat(page - 1, ")\">\n    <span aria-hidden=\"true\">&lt;</span>\n  </a>");
  }

  for (var i = first; i <= last; i++) {
    //  pageNationHTML += -> pageNationHTML = pageNationHTML + 페이지(li) 태그
    pageNationHTML += "<li class=\"page-item ".concat(page == i ? "active" : "" //페이지 active 효과 삼항 연산자 이용 ${page == i ? "active" : ""}
    , "\"><a class=\"page-link\" href=\"#\" onclick=\"moveToPage(").concat(i, ")\">").concat(i, "</a></li>"); // 페이지 버튼 클릭시 페이지 이동 onclick 이벤트 속성 부여 moveToPage(${i}) 몇번째 페이지 클릭했는데 매개변수${i}로 받아준다.
  } // 페이지 이동 마지막 화살표 표시


  if (last <= last) {
    pageNationHTML += "\n</li> <li class=\"page-item\">\n  <a class=\"page-link\" href=\"#\" aria-label=\"Next\" onclick=\"moveToPage(".concat(page + 1, ")\">\n    <span aria-hidden=\"true\">&gt;</span>\n  </a>\n</li><li class=\"page-item\">\n<a class=\"page-link\" href=\"#\" aria-label=\"Next\"onclick=\"moveToPage(").concat(last + 1, ")\">\n  <span aria-hidden=\"true\">&gt;&gt</span>\n</a>");
  }
...
var errorRender = function errorRender(message) {
  var errorHTML = "<div class=\"alert alert-danger text-center\" role=\"alert\">".concat(message, "\n  A simple danger alert\u2014check it out!\n</div>");
